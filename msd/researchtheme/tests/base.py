...
def setup_product():
    ...
    import msd.researchtheme
    zcml.load_config('configure.zcml', msd.researchtheme)
    ...
    ztc.installPackage('msd.researchtheme')
...
setup_product()
ptc.setupPloneSite(products=['msd.researchtheme'])
